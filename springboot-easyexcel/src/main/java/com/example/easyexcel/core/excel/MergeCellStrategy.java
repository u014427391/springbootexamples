...
public abstract class MergeCellStrategy implements RowWriteHandler {
    ...
    public MergeCellStrategy(Class<?> elementType) {
    ...
    private void lazyInit(WriteSheetHolder writeSheetHolder) {
        ...
        for (Field theField : fields) {
            ...
            // 获取自定义的注解，用于合并单元格
            EasyExcelCollection customMerge = theField.getAnnotation(EasyExcelCollection.class);
